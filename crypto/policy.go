//go:generate mockgen -destination=mocks/mock_signature_policy.go -package=mocks github.com/invin/kkchain/crypto SignaturePolicy
//go:generate mockgen -destination=mocks/mock_hash_policy.go -package=mocks github.com/invin/kkchain/crypto HashPolicy
